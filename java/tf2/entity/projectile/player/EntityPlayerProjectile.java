...
public class EntityPlayerProjectile extends Entity implements IProjectile
{
	protected int xTile;
	protected int yTile;
	protected int zTile;
	...
	public EntityPlayerProjectile(World worldIn)
	{
		super(worldIn);
		this.xTile = -1;
		this.yTile = -1;
	...
	public EntityPlayerProjectile(World worldIn, double x, double y, double z)
	{
		this(worldIn);
		this.setPosition(x, y, z);
	}

	public EntityPlayerProjectile(World worldIn, EntityLivingBase throwerIn)
	{
