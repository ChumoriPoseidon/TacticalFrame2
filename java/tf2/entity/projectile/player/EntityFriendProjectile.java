...
public class EntityFriendProjectile extends Entity implements IProjectile
{
	protected int xTile;
	protected int yTile;
	protected int zTile;
	...
	public EntityFriendProjectile(World worldIn, double x, double y, double z)
	{
		this(worldIn);
		this.setPosition(x, y, z);
	}

	public EntityFriendProjectile(World worldIn, EntityLivingBase throwerIn)
	{
