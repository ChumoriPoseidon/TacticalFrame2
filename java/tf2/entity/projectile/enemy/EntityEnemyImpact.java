...
public class EntityEnemyImpact extends EntityEnemyProjectile
{
	...
	public static void registerEntity(Class<EntityEnemyImpact> clazz, ResourceLocation registryName, String name, int trackingRange, int updateFrequency, boolean sendsVelocityUpdates)
	{
