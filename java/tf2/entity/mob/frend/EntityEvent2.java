...
public class EntityEvent2 extends EntityMobNPC implements IRangedAttackMob
{
	...
	public void isMission()
	{
		...
		{
			String d = I18n.translateToLocal("tf.mission2.txt1");
			this.isChat(d);
		}
		if (this.eventTime == 300)
		{
			String d = I18n.translateToLocal("tf.mission2.txt2");
			this.isChat(d);
		}
		if (this.eventTime == 400)
		{
			String d = I18n.translateToLocal("tf.mission2.txt3");
			this.isChat(d);
		}
		if (this.eventTime == 500)
		{
			String d = I18n.translateToLocal("tf.mission2.txt4");
			this.isChat(d);
		}
		if (this.eventTime == 600)
		{
			String d = I18n.translateToLocal("tf.mission2.txt5");
			this.isChat(d);
		}
	...
	public void isClear()
	{
		...
		{
			String d = I18n.translateToLocal("tf.mission2.txt6");
			this.isChat(d);
		}
		if (this.eventTime2 == 200)
		{
			String d = I18n.translateToLocal("tf.mission2.txt7");
			this.isChat(d);
		}
		if (this.eventTime2 == 400)
		{
			String d = I18n.translateToLocal("tf.mission2.txt8");
			this.isChat(d);
		}
		if (this.eventTime2 == 500)
		{
			String d = I18n.translateToLocal("tf.mission2.txt9");
			this.isChat(d);
