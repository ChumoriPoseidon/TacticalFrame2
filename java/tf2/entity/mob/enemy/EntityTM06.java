...
public class EntityTM06 extends EntityMobTF implements IRangedAttackMob
{
	...
	public EntityTM06(World worldIn)
	{
		...
		this.moveHelper = new EntityTM06.TM45AMoveHelper(this);
	...
	protected void initEntityAI()
	{
		...
		this.tasks.addTask(5, new EntityTM06.AIRandomFly(this));
		this.tasks.addTask(7, new EntityTM06.AILookAround(this));
...
//			if (f < 20.0D)
//			{
//				this.motionX = -(d0 / (double) f2 * 0.01D * (30.0D - f) + this.motionX * 0.3D);
//				this.motionZ = -(d1 / (double) f2 * 0.01D * (30.0D - f) + this.motionZ * 0.3D);
//			}
		}
		else
		{
	...
	{
		private final EntityTM06 parentEntity;

		public AILookAround(EntityTM06 TM45A)
		{
	...
	static class AIRandomFly extends EntityAIBase
	{
		...
		public AIRandomFly(EntityTM06 entityTM45A)
		{
	...
	static class TM45AMoveHelper extends EntityMoveHelper
	{
		...
		public TM45AMoveHelper(EntityTM06 TM45A)
		{
			super(TM45A);
			this.parentEntity = TM45A;
		}
