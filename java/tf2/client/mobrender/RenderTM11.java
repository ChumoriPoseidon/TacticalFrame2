...
public class RenderTM11 extends Render
{
	...
	private static final ResourceLocation tfeyes = new ResourceLocation("tf2:textures/mob/tm11eye.png");
	...
	private void renderlegs(EntityTM11 entity)
	{
		...
		float t3 = (float)Math.sin(x / ((float)Math.PI * 0.9662F)) * 50F;
    ...
    {
		GlStateManager.pushMatrix();
		GlStateManager.translate(0F, 1.51F, 0.0F);
		GlStateManager.translate(-0.37F, 0.0F, 0.02F);
		GlStateManager.rotate((iii2), 1.0F, 0.0F, 0.0F);
        GlStateManager.translate(0F, -1.51F, 0F);
        GlStateManager.translate(0.37F, 0F, -0.02F);
        tankk.renderPart("rightleg");
        tankk.renderPart("rightthighs");
        GlStateManager.popMatrix();
