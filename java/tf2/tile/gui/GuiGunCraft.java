...
public class GuiGunCraft extends GuiContainer
{
    ...
    {
        this.fontRenderer.drawString(I18n.format("gui.guncraft", new Object[0]), 8, 6, 4210752);
...
//        }
	...
	public void drawScreen(int x, int y, float par3)
	{
		...
		if(this.currentRecipeIndex == 1)
		{
			...
			this.drawTexturedModalRect(x1 + 202, y1 + 75, 64, 224, 16, 16);
		}
		if(this.currentRecipeIndex == 2)
		{
			this.drawTexturedModalRect(x1 + 202, y1 + 17, 96, 224, 16, 16);
			this.drawTexturedModalRect(x1 + 202, y1 + 75, 80, 224, 16, 16);
		}
        RenderHelper.enableStandardItemLighting();
	}
